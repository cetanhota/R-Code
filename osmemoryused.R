...
plot(wwldf$ts, wwldf$os_mem_used, type="l", col="red", xlab="server: rose-lab1", ylab="Used in MB")
title(main=paste("Memory Used"), sub=, col.main="black")
grid(nx = NULL, ny = NULL, col = "lightgray", lty = "solid", lwd = par("lwd"), equilogs = TRUE)

plot(wwldf$ts, wwldf$os_mem_free, type="l", col="green", xlab="server: rose-lab1", ylab="Free in MB")
title(main=paste("Memory Free"), sub=, col.main="black")
grid(nx = NULL, ny = NULL, col = "lightgray", lty = "solid", lwd = par("lwd"), equilogs = TRUE)
